...
public class TicketController
{
    ...
    @RequestMapping(value = "/", method = RequestMethod.GET, params = "userId", produces = MediaType.APPLICATION_PDF_VALUE)
    ...
    @RequestMapping(value = "/", method = RequestMethod.GET, params = "eventId")
